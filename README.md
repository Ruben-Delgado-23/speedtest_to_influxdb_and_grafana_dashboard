...
You can use InfluxDB queries to visualize your internet speed data. For example, you can use a query like FROM default "speedtest"  SELECT field("upload") distinct() GROUP BY time($_interval)
